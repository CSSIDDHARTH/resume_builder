...
const testimonials = [
    {
        ...
        text: 'ResumeAI rewrote my summary in seconds and I got 3 interview calls within a week. Absolute game-changer!',
        stars: 5,
    },
    {
        ...
        text: 'The AI enhancement feature is genuinely incredible. My job descriptions now sound 10x more compelling.',
        stars: 5,
    },
    {
        ...
        handle: '@sofia_ux',
        role: 'UX Designer',
        text: "I uploaded my old PDF resume and ResumeAI auto-filled everything perfectly. Saved me hours of work.",
        stars: 5,
    },
    {
        ...
        text: 'Clean templates, ATS-friendly output, and the PDF export looks flawless. Best free resume tool out there.',
        stars: 5,
    },
    {
        ...
        handle: '@zoewrites',
        role: 'Data Analyst',
        text: 'The color picker and template options made it so easy to create a professional-looking resume that feels uniquely mine.',
        stars: 5,
    },
    {
        ...
        text: 'I love how it syncs everything in real time. The live preview kept me confident in every edit I made.',
        stars: 5,
    },
    {
        ...
        handle: '@amara_codes',
        role: 'ML Engineer',
        text: 'Sharing a public link with recruiters is such a smart feature. My resume got noticed because of how polished it looked.',
        stars: 5,
    },
    {
        ...
        handle: '@rajpatel_io',
        role: 'Full Stack Dev',
        text: 'Switching from Google Docs to ResumeAI was the best decision. My resume instantly looked 10x more professional.',
        stars: 5,
    },
]
...
const Card = ({ t }) => (
    <div
        className="mx-3 shrink-0 w-72 rounded-2xl p-5"
        style={{
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                <div className="flex flex-col items-center text-center mb-12">
                    <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-6 text-xs font-semibold"
                        ...
                        <Star size={11} fill="#a5b4fc" color="#a5b4fc" />
                        Loved by Users
                    </div>
                    <h2 className="text-3xl sm:text-5xl font-black mb-4" style={{ letterSpacing: '-0.02em' }}>
                        <span style={{ color: '#e2e8f0' }}>Don't take our word for it</span>
                    </h2>
