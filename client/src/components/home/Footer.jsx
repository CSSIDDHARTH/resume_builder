...
const Footer = () => {
    ...
    return (
        <footer id="contact" className="relative overflow-hidden border-t"
            style={{ background: 'linear-gradient(180deg, #070b14 0%, #040810 100%)', borderColor: 'rgba(255,255,255,0.05)' }}>
                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    <div className="md:col-span-1">
                        ...
                        <p className="text-sm leading-relaxed mb-6" style={{ color: '#475569' }}>
                            Build modern, ATS-friendly resumes in minutes with AI-powered writing assistance and beautiful templates.
                        </p>
                        <div className="flex gap-3">
                            {[FaGithub, FaLinkedin, FaTwitter].map((Icon, i) => (
                                <a key={i} href="#" target="_blank" rel="noopener noreferrer"
                                    ...
                                    onMouseLeave={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.05)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = '#64748b' }}>
                                    <Icon size={16} />
                                </a>
                            ))}
                        </div>
                    ...
                    {Object.entries(links).map(([group, items]) => (
                        <div key={group}>
                            <h3 className="font-semibold mb-5" style={{ color: '#94a3b8', letterSpacing: '0.05em', textTransform: 'uppercase', fontSize: '0.7rem' }}>
                                {group}
                            </h3>
